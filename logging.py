...
logging.basicConfig(format='%(asctime)s - %(message)s', datefmt='%b-%d-%y %H:%M:%S') # only keep this for testing
...
logging.basicConfig(level=logging.DEBUG,filename='practice.log', filemode='w', format='%(asctime)s - %(message)s', datefmt='%d-%b-%y %H:%M:%S')
